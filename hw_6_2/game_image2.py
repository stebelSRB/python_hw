...
class game_image2(game_image):
    ...
    def save_img(self, file_name_result: str) -> None:
        '''
            зберігає зображення у файл
        '''

        self.img.save(file_name_result, "JPEG")
    ...
    def game_interface(self) -> None:
        ...
        while running:
            ...
            match current_command:
                ...
                case 7:
                    file_name_result = input('Введіть назву файлу:')
                    print('зображення збережено')
                    self.save_img(file_name_result)
                    running = False
                case 8:
                ...
                case 2 | 3 | 4 | 5 | 6:
                    ...
                    self.transform_image(name_method)
                case _:
                    print('такої команди не існує, роботу завершено')
                    running = False
