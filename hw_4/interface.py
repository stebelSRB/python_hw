...
'''
Тут описана функція котра надає інтерфейс для роботи з "інструментами модифікації зображення".
'''

import numpy as np
from PIL import Image
from matplotlib import pyplot as plt
from tools import reduce, turn_left, turn_right, mirror_vertical, mirror_horizon

# ----------------------- інтерфейс для обробки зображення --------------------------
def game_with_image(file_name_raw: str, file_name_result: str) -> None:
    ...
    while running:
        ...
        match current_command:
            ...
            case 8:
                ...
                running = False
            case 2 | 3 | 4 | 5 | 6:
                func_name = tools_image[current_command]
                img_array = np.asarray(img)
                img = globals()[func_name](img_array)
            case _:
                print('такої команди не існує, роботу завершено')
                running = False
